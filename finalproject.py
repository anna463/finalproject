...
ALGORITHM:
First, we will create code that check who won each round
...
Fourth, we will create code that checks if the user wants to quit, or if the user doesn't enter on of the options (rock, paper, or scissors)
